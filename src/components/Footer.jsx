export default function Footer() {
  return (
    <footer className="bg-green-50 border-t border-green-200 text-gray-700 py-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Column 1: Logo & Tagline */}
        <div>
          <h3 className="text-2xl font-extrabold text-green-800 mb-2">Oasis Gardens</h3>
        ...
        <div>
          <h4 className="font-semibold text-green-700 mb-3">Explore</h4>
      ...
      {/* Bottom Bar */}
      <div className="max-w-7xl mx-auto px-6 mt-8 pt-6 border-t border-green-200 text-sm text-center md:flex md:justify-between md:text-left">
        <p>© {new Date().getFullYear()} Oasis Gardens & Caterers. All rights reserved.</p>
        <p className="mt-2 md:mt-0">
          Website by <span className="font-semibold text-green-700">GlimmerInk Creations</span>
        </p>
      </div>
    </footer>
  );
